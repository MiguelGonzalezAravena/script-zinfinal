...
if($global_user['rango']==11) {
	echo '<!-- mensaje-top-->
<div id="mensaje-top">
<div class="msgtxt">Logr&aacute; un post con m&aacute;s de 50 puntos y ser&aacute;s Full User</div>
</div>
<!-- fin mensaje-top-->';
}
					...
					<div class="box_title">
						...
						<div id="mensaje-top">
							...
							<div class="box_cuerpo">
								...
								<input type="hidden" name="key" value="9fb8c8">
															<b>T&iacute;tulo:</b><br /><input class="agregar titulo" type="text" size="60" maxlength="60" name="titulo" tabindex="1" /><span class="capsprot">El titulo no debe estar en may&uacute;sculas</span><br /><br />

								<b>Mensaje del post:</b><br />
								<textarea id="markItUp" class="agregar cuerpo" name="cuerpo" tabindex="2"></textarea>
								...
								<b>Tags:</b><br /><input class="agregar tags" type="text" size="60" maxlength="128" name="tags" tabindex="4" /><br />
...
while($categorias = mysql_fetch_array($sqlc)) {
	echo "<option value=\"{$categorias['id_categoria']}\">{$categorias['nom_categoria']}</option>\n";
}
...
if($global_user['rango']!='11'){
	...
	<input class="agregar check" type="checkbox" name="privado"/> Solo usuarios registrados<br /><br />	';
}

if($global_user['rango']=='255' or $global_user['rango']=='100'){
	echo '<b>Opciones Avanzadas:</b><br /><input class="agregar check" type="checkbox" name="sticky"/> Establecer como Sticky<br />
	<input class="agregar check" type="checkbox" name="patrocinado"/> Establecer como Patrocinado y Sticky<br />
	<input class="agregar check" type="checkbox" name="coments"/> No permitir comentarios<br />';
}

if($global_user['rango']=='50'){
	echo '<input class="agregar check" type="checkbox" name="patrocinado"/> Establecer como Patrocinado y Sticky<br />';
}
